...
AttributeTypes](#Elements-and-AttributeTypes) - [Alternatives
Generation](#alternatives-generation) - [Matrix
Generation](#matrix-generation) - [Seeds](#seeds) - [Multiple
...
```
    ...
    [('LittleShape', <AttributeType.COLOR: 3>), ('LittleShape', <AttributeType.LITTLESHAPENUMBER: 11>), ('LittleShape', <AttributeType.SHAPE: 1>), ('LittleShape', <AttributeType.ANGLE: 4>), ('LittleShape', <AttributeType.SIZE: 2>)]

![](omss_documentation_files/figure-commonmark/cell-15-output-2.png)
...
```
    ...
    [('LittleShape', <AttributeType.LITTLESHAPENUMBER: 11>), ('LittleShape', <AttributeType.SHAPE: 1>), ('LittleShape', <AttributeType.ANGLE: 4>), ('LittleShape', <AttributeType.COLOR: 3>), ('LittleShape', <AttributeType.SIZE: 2>)]

![](omss_documentation_files/figure-commonmark/cell-16-output-2.png)
...
```
    ...
    [('BigShape', <AttributeType.COLOR: 3>), ('BigShape', <AttributeType.SHAPE: 1>), ('Line', <AttributeType.ANGLE: 4>), ('Line', <AttributeType.LINETYPE: 6>), ('Line', <AttributeType.LINENUMBER: 9>), ('BigShape', <AttributeType.ANGLE: 4>), ('BigShape', <AttributeType.SIZE: 2>)]

![](omss_documentation_files/figure-commonmark/cell-17-output-2.png)
...
and `COLOR` attributes of the `BigShape` element, while the `Line`
element is governed by a `CONSTANT` rule. Since the line does not
contribute to the underlying logic of the puzzle, the program correctly
avoids modifying it when generating alternatives.

However, if we now remove the `DISTRIBUTETHREE` rule from the `COLOR`
attribute of `BigShape` and instead apply `DISTRIBUTETHREE` to the
...
program may introduce modifications to `LINETYPE` as well—since it is
now governed by a rule that makes it relevant to the puzzle logic.
...
```
    ...
    [('BigShape', <AttributeType.SHAPE: 1>), ('Line', <AttributeType.LINETYPE: 6>), ('Line', <AttributeType.ANGLE: 4>), ('Line', <AttributeType.LINENUMBER: 9>), ('BigShape', <AttributeType.ANGLE: 4>), ('BigShape', <AttributeType.COLOR: 3>), ('BigShape', <AttributeType.SIZE: 2>)]

![](omss_documentation_files/figure-commonmark/cell-18-output-2.png)
