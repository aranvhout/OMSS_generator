...
Mat1 = create_matrix(rules, alternatives=4, seed = None, alternative_seed =None , entity_types=['BigShape', 'LittleShape'], save = False)


# plt.show(Mat1["FullMatrix"])
...
from entity import Colors, Sizes, Shapes
Colors._member_names_
Sizes._member_names_
Shapes._member_names_
...
rules = {
    'LittleShape': [
        ...
        Rule(Ruletype.CONSTANT, AttributeType.COLOR),
        Rule(Ruletype.CONSTANT, AttributeType.SIZE),
        Rule(Ruletype.POSITION, AttributeType.POSITION)]}
