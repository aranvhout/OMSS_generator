...
**omss** is a Python package for generating matrix reasoning puzzles, inspired by Raven's Progressive Matrices, designed to assess fluid intelligence. It allows users to generate an unlimited number of customizable puzzles across a range of difficulty levels. test 
...
Amazing! As you can see, the arithmetic operation is being combined across the two elements, resulting in a coordinated numeric progression between LittleShape and BigShape.
